...
When needing to use sound effects, load the [./references/sound-effects.md](./references/sound-effects.md) file for more information.
...
- [references/voiceover.md](references/voiceover.md) - Adding AI-generated voiceover to Remotion compositions using ElevenLabs TTS
