...
registerAgent({
  id: 'rebuild',
  displayName: 'RebuilD',
  role: '自主软件工程 Agent，理解/规划/执行任何软件任务',
  runMode: 'react',
  defaultMaxLoops: 30,
  defaultPrompt: '',
  tools: [
    ...
    { name: 'rag_retrieve', description: 'RAG 检索' },
    { name: 'discover_skills', description: '发现技能' },
    { name: 'read_skill_resource', description: '读取技能资源' },
    { name: 'search_vision_knowledge', description: '检索知识库' },
    { name: 'search_decisions', description: '检索决策记录' },
    { name: 'search_code_artifacts', description: '检索代码产物' },
    { name: 'search_code_patterns', description: '检索代码模式' },
